...
void _help()
{
    ...
    printf("<username>ftpuser</username> 远程服务器ftp的用户名。\n");
    printf("<password>Wangwang123456</password> 远程服务器ftp的密码。\n");
    ...
    printf("<checkmtime>true</checkmtime> 是否需要检查服务端文件的时间， true-需要 false -不需要，此参数只有当ptype=1时有效，缺省为true \n");

    printf("<timeout>80</timeout> 下载文件的超时时间 \n");
