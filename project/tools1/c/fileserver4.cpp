...
// 接收上传文件得内容
bool RecvFile(const int sockfd, const char *filename, char *mtime, int filesize);
...
void RecvFilesMain()
{
  while (true)
  {
    ...
    if(strncmp(strrecvbuffer,"<filename>", 10) == 0)
    {
      ...
      // 客户端和服务端得目录是不相同得，以下代码生成服务端得文件名
      // 把文件名中得clientpath替换程srvpath,要小心第三个参数
