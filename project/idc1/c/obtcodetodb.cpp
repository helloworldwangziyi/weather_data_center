/*
 obcodetodb.cpp 本程序用于把全国站点参数数据保存到数据库T_ZHUOBTCODE表中
 作者：王梓伊
*/
#include "_public.h"
#include "_mysql.h"
...
int main(int argc, char *argv[])
{
    ...
    if(argc != 5)
    {
        ...
        printf("Example:./project/tools1/bin/procctl 120 /project/idc1/bin/obtcodetodb /project/idc/ini/stcode.ini \"127.0.0.1,root,Wangwang123456,mysql,3306\" utf8 /log/idc/obtcodetodb.log\n\n ");
        ...
        printf("程序每120秒运行一次，由procctil 调度 \n\n\n");
    ...
    logfile.Write("总记录数=%d,插入=%d,更新=%d, 耗时=%.2f秒",vstcode.size(), inscount,uptcount,Timer.Elapsed());
